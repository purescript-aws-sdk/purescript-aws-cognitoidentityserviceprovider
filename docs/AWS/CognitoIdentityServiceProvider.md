...
``` purescript
adminAddUserToGroup :: forall eff. AdminAddUserToGroupRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
adminDeleteUser :: forall eff. AdminDeleteUserRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
adminForgetDevice :: forall eff. AdminForgetDeviceRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
adminRemoveUserFromGroup :: forall eff. AdminRemoveUserFromGroupRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteIdentityProvider :: forall eff. DeleteIdentityProviderRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteResourceServer :: forall eff. DeleteResourceServerRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteUserPool :: forall eff. DeleteUserPoolRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteUserPoolClient :: forall eff. DeleteUserPoolClientRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
forgetDevice :: forall eff. ForgetDeviceRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
